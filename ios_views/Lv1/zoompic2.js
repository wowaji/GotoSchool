...
var zoompic2 = React.createClass({
    ...
    render:function(){
        return(
          <View style={styles.flex}>
                   ...
                   <Image style={styles.pic}  source={require('image!Image-12') }></Image>
                    </View>

               <View style={styles.flex0}>
                   <Text style={styles.font0}>找8处不同</Text>
    ...
    componentWillUnmount: function () {
	    clearInterval(this.setInterval);
                                ...
                                next:function(){
                                  ...
                                  s=2;};
                                  AsyncStorage.setItem("result[6]",JSON.stringify(s));
