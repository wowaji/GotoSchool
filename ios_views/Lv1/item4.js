...
var item4= React.createClass({
  ...
  return {
  types: [{label: '想着他是小弟弟，就让他一回算了。', value: 15},
           {label: '不让他，大家都要守规矩。',value: 5},
           {label: '问清楚他插队的原因，再决定要不要让他。', value: 20},
           {label: '告诉小弟弟要排队，如果不听，就告诉他妈妈。',value: 10},],
  value: 0,
  valueIndex: 0,
                                             }
  },
  componentDidMount() {
    var audioPath = AudioUtils.DocumentDirectoryPath + '/4.caf';
      ...
      this.setState({finished: data.finished});
                        ...
                        <TouchableOpacity   onPress={() => this._stop()}>
                           <Image style={styles.icon}  resizeMode="contain"  source = {require('image!icon-4')}>
                                    ...
                                    <Text style={styles.askfont}>请家长告知孩子，手机里会讲一个小故事，如果他（她）是故事里的人物会怎么办呢？</Text>
                                    </View>
                                    </View>
                                    </View>
                                    </Image>
                             ...
                             else{AudioRecorder.playRecording('/4.caf');
                             ...
                             nextbtn:function(){
                              ...
                              this._stop();}
                               ...
                               var v4=(this.state.value);
                       AsyncStorage.setItem("result[4]",JSON.stringify(v4));
