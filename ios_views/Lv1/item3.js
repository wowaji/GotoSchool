...
var item3= React.createClass({
  ...
  componentDidMount() {
    var audioPath = AudioUtils.DocumentDirectoryPath + '/3.caf';
      ...
      this.setState({finished: data.finished});
                        ...
                        <TouchableOpacity   onPress={() => this._stop()}>
                           <Image style={styles.icon}  resizeMode="contain"  source = {require('image!icon-4')}>
                                    ...
                                    <Text style={styles.askfont}>接下来是英文短句的播放.请孩子认真听，听完后学着说一遍。</Text>
                                     <Text style={styles.askfont2}>What? This is wig for a pig?</Text>
                                        </View>
                                        </View>
                                        </View>
                                    </Image>
                             ...
                             else{AudioRecorder.playRecording('/3.caf');
                             ...
                             nextbtn:function(){
                              ...
                              this._stop();}
                               ...
                               var v3=(this.state.value);
                       AsyncStorage.setItem("result[3]",JSON.stringify(v3));
